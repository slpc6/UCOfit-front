...
const RequestPasswordRecovery = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(response.message === 'Si el correo existe en nuestro sistema, recibirás un email para resetear la contraseña.');
    } catch (err) {
      setError(`Error al enviar la solicitud de recuperación. ${err}`);
    } finally {
      setLoading(false);
    }
  };
